...
@login_required
def add():
    # Add this at the beginning of your route
    print("Current user type:", type(current_user))
    try:
        current_user.debug_info()  # This will print all relevant user info
    except Exception as e:
    ...
    if form.validate_on_submit():
        try:
            # Make sure to set the registered_by field explicitly
            form.registered_by.data = current_user.get_id()
            ...
            patient_data = {
                ...
                'registered_by': current_user.get_id()  # Use get_id() to access the ID reliably
            }
